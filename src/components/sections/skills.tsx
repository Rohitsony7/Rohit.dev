...
export function SkillsSection() {
  ...
  const skillCategories: SkillCategory[] = Object.entries(
    resumeData.skills_categories || {}
  ).map(([key, value]) => ({
    name: key
      .split("_")
    ...
    <section id="skills" className="py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="container px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto relative z-10">
        <div className="flex flex-col gap-4 mb-12 md:mb-16">
          ...
          >
            With {resumeData.bio.split(" ")[2]} years of experience, I've
            mastered a diverse range of technologies and tools to build
