          ...
          <div className="lg:w-1/2">
            <div className="max-w-md">
              ...
              <p className="text-muted-foreground mb-8">
                Have a project in mind? Feel free to reach out. I'm always open to discussing new projects, creative ideas or opportunities to be part of your vision.
              </p>
              ...
              <div className="space-y-6">
                <ContactInfo 
                  ...
                  title="Email"
                  value="hello@rohitsony.dev"
                  href="mailto:hello@rohitsony.dev"
                />
                ...
                <div className="flex gap-4">
                  ...
                  <SocialButton 
                    name="Twitter" 
                    href="https://twitter.com/rohitsony7" 
                    icon={
                      <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
